...
<body>
    ...
    <form action="../atm/atm_momo1.php" method="post" class="form-container">
        <input type="hidden" name="id_sp" value="<?php echo htmlspecialchars($id_sp); ?>">
        ...
        <div class="form-row">
            <h2>Sản phẩm</h2>
            <input type="text" name="ds_sp" value="<?php echo $sp; ?>">
        </div>
        <div class="form-row">
            <h2>Mã khuyến mãi</h2>
